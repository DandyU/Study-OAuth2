    ...
    public void readUsers() throws Exception {
        ...
        mockMvc.perform(get("/api/users")
                ...
                .andDo(document("read-users",
                        ...
                        responseFields(
                                fieldWithPath("_embedded.xUserList[0].id").description("User ID"),
                                fieldWithPath("_embedded.xUserList[0].variableId").description("User name"),
                                fieldWithPath("_embedded.xUserList[0].password").description("User description"),
                                fieldWithPath("_embedded.xUserList[0].name").description("User startEnrollmentDateTime"),
                                fieldWithPath("_embedded.xUserList[0].roles").description("User endEnrollmentDateTime"),
                                fieldWithPath("_embedded.xUserList[0]._links.self.href").description("Link to self"),
                                fieldWithPath("_embedded.xUserList[0]._links.update-user.href").description("Link to update"),
                                fieldWithPath("_embedded.xUserList[0]._links.delete-user.href").description("Link to delete"),
